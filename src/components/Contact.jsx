  ...
  return (
    <div className="xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden">
      ...
      className="flex-[0.75] bg-black-100 p-8 rounded=2xl">
        ...
        <h3 className={`${styles.heroSubText}`}>Fr Joseph</h3>
        <p>St. Vincent Pallotti Church Balaji Layout, Banaswadi, Bengaluru, Karnataka 560043</p>
        <p>Website: <a href="https://github.com/ssathvick">My Github Repository</a></p>
        <p>Phone Number: +91 8762468171</p>
